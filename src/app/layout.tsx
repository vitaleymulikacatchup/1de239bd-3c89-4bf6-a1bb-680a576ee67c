...
export const metadata: Metadata = {
  title: "Personal Photo Studio - Professional Photography Services",
  description: "Capture your precious moments with our professional photography studio. Specializing in portraits, weddings, and events.",
  keywords: "photography studio, professional photographer, portrait photography, wedding photography, event photography",
  openGraph: {
    title: "Personal Photo Studio - Professional Photography Services",
    description: "Capture your precious moments with our professional photography studio.",
    siteName: "Studio",
    type: "website"
  }
};
